# Miro Richhardt — Portfolio

Personal portfolio and resume site built with vanilla HTML, CSS, and JavaScript. No frameworks, no build step — just static files deployed via GitHub Pages.

**Live site:** https://fmeilrios.github.io/portfolio
...
```bash
git clone https://github.com/Fmeilrios/portfolio
cd portfolio
